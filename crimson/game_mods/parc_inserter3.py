...
def insert_item_to_inventory(
    ...
    from crimson.game_mods.save_parser import build_result_from_raw as _brfr
    from crimson.game_mods import parc_serializer as _ps
...
def clone_block_section(
    ...
    from crimson.game_mods import parc_serializer as _ps2
...
def rebuild_dye_list(
    ...
    _ensure_desktop_path()
    from crimson.game_mods.save_parser import build_result_from_raw as _brfr
    from crimson.game_mods.parc_inserter2 import parse_and_collect, collect_all_positions
...
def insert_dye_to_item(
    ...
    from crimson.game_mods.parc_inserter2 import collect_all_positions
    ...
    try:
        ...
        for base in [_MY_DIR, getattr(sys, '_MEIPASS', _MY_DIR)]:
            ...
            if os.path.isfile(p):
                ...
                break
        if cdata_path:
            from crimson.game_mods.save_crypto import load_save_file as _lsf
